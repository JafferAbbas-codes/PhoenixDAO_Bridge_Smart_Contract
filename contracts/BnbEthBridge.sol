...
contract BnbEthBridge {
    ...
    function burnToken(uint256 amount) public returns (uint256) {
        address sender = msg.sender;
        IERC20(phnxAddress).transferFrom(sender, address(this), amount);
        IERC20(phnxAddress).transfer(0x0000000000000000000000000000000000000001, amount);
    ...
    function mintToken(
        ...
        require(sigRepeated[encodeData] == false, "Already claimed");
